...
?>
				<div class="col-md-4 div-center order-confirmed">
					...
					<div class="col-md-4 div-center order-confirmed">
						...
						<div class="wrap-confirmation">
							...
							<div class="fourth">
								...
								<div class="col-md-6 col-sm-6 col-xs-6">
									<p><?php echo $receipt_info['address']['firstName'] ?> <?php echo $receipt_info['address']['lastName'] ?></p>
								</div>
								<div class="col-md-6 col-sm-6 col-xs-6">
									<p><?php echo $receipt_info['shippingAddress']['firstName'] ?> <?php echo $receipt_info['shippingAddress']['lastName'] ?></p>
								</div>
								<div class="col-md-6 col-sm-6 col-xs-6">
