...
<div class="img-container">
	...
	<div class="grey-image"><img style="display: none;" id="InspirationImage" class="img-responsive" src="<?php echo wp_get_attachment_url( $inspiration->post_image ); ?>" alt="" /></div>
