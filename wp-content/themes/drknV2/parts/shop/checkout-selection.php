	...
	<tr>
		<td>
			<p>
				...
				<a style="text-decoration: none" href="<?php echo EscGeneral::getQueryAddProduct( $item ); ?>">ADD</a> |
				<a style="text-decoration: none" href="<?php echo EscGeneral::getQueryRemoveProduct( $item ); ?>">REMOVE</a>
			</p>
		</td>
		<td>
			<p class="text-right">
