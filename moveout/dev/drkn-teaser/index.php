...
<body>
    <header>
        <div class="left-side">
			...
			<p class="toggle-code"> &gt;&gt;&gt; ENTER CODE FOR EARLY ACCESS &lt;&lt;&lt; </p>
        </div>
    ...
    <div class="code-dialog">
		<div class="close-code-dialog">&times;</div>
		<p style="text-align: center;">First person through will <br/> be respectfully rewarded.</p><br/>
		<input type="text" placeholder="Enter Code"/> <br/>
		<input type="text" placeholder="Enter E-mail"/>
		<p class="form-code-error email">Invalid e-mail</p>
		<p class="form-code-error code">Invalid code</p>
		<div class="button">
			<div class="button-left"><img src="<?php echo $cdn ?>img/button-side-left.jpg" alt=""/></div>
			<div class="button-title">Enter</div>
			<div class="button-right"><img src="<?php echo $cdn ?>img/button-side-right.jpg" alt=""/></div>
		</div>
    </div>
