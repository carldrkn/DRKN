...
?>
			<div class="row checkout-selection">
				<div class="col-md-12">
					<div class="row">
					<a href="<?php the_field('page_category', $post_id);?>#product-<?=$post_id?>" class="col-md-5 col-sm-5 col-xs-12">
						<div class="row">
...
<?
	...
	function esc_checkout_totals($totals = array(), $items = array()) {
		...
		ob_start();
?>
		<div id="checkout-cont" class="checkout-cont" data-item-count="<?=count($items)?>">
			<ul id="co-summary" class="ul-clean">
				<li>Frakt <span class="lighter-text">(Sverige)</span><span class="right-side"><?=$totals['shippingPrice']?></span></li>
<?
...
?>
				<li class="sales-tax lighter-text">Moms<span class="right-side">(<?=$totals['grandTotalPriceTax']?>)</span></li>
				<li class="grand-total">
					<h3 class="clearfix"><?=($before_receipt?'Att betala':'Betalt')?><br><span class="lighter">(inkl moms &amp; leverans)</span><br/><span class="total"><?=$totals['grandTotalPrice']?></span></h3>
				</li>
			</ul>
		</div>
<?
